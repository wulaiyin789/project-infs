    ...
    <div id="info">
        ...
        <div class="jumbotron container-fluid padding">
            <div class="row intro text-center">
                <div class="col-12">
                    <h1 class="display-5">Foods Details</h1>
                </div>
                <hr>
            </div>
            ...
            <div class="row text-center padding">
                <div class="col-xs-12 col-sm-6 col-md-6 feature">
                    ...
                    <h3>Foods</h3>
                    <p>User can find lots of different foods from this website!</p>
